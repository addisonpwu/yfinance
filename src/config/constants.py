...
AI_ANALYSIS_SUMMARY_MAX_LENGTH = 5000
...
DB_EXPIRE_ON_COMMIT = False  # 提交后对象是否过期
...
STOCK_NAME_MAX_LENGTH = 255
STOCK_MARKET_MAX_LENGTH = 10
NEWS_URL_MAX_LENGTH = 512
NEWS_TITLE_MAX_LENGTH = 1000  # Text field, but set for validation
